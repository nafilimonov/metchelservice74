...
// Код формы
$iAdmin_Form_Id = 343;
$sAdminFormAction = '/{admin}/siteuser/shop/favorite/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Siteuser.shop_siteuser_favorite_title', $oSiteuser->login))
	->pageTitle(Core::_('Siteuser.shop_siteuser_favorite_title', $oSiteuser->login));
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Siteuser_Shop_Favorite')
);
