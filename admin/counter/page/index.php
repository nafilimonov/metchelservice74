...
$oAdmin_Form_Dataset->addCondition(
	array('select' => array('counter_pages.*', array($bSeveralDates ? 'SUM(count)' : 'count', 'dataCount')))
)
->addCondition(
...
Core_Event::attach('Admin_Form_Controller.onAfterSetConditionsAndLimits', array('Counter_Page_Observer', 'onAfterSetConditionsAndLimits'));
