...
$oAdmin_Form_Dataset->addCondition(
	array('select' => array('counter_searchqueries.*', array($bSeveralDates ? 'SUM(count)' : 'count', 'dataCount')))
)
->addCondition(
...
class Counter_Searchsystem_Observer
{
...
Core_Event::attach('Admin_Form_Controller.onAfterSetConditionsAndLimits', array('Counter_Searchsystem_Observer', 'onAfterSetConditionsAndLimits'));
