...
$oAdmin_Form_Dataset->addCondition(
	array('select' => array('counter_devices.*', array($bSeveralDates ? 'SUM(count)' : 'count', 'dataCount')))
)
->addCondition(
...
Core_Event::attach('Admin_Form_Controller.onAfterSetConditionsAndLimits', array('Counter_Device_Observer', 'onAfterSetConditionsAndLimits'));
