	...
	public function getMenu()
	{
		$this->menu = array(
			array(
				...
				'href' => Admin_Form_Controller::correctBackendPath("/{admin}/lib/index.php"),
				'onclick' => Admin_Form_Controller::correctBackendPath("$.adminLoad({path: '/{admin}/lib/index.php'}); return false")
			)
		);
