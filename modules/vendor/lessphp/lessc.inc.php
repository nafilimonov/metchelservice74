...
class lessc {
	...
	protected function tryImport($importPath, $parentBlock, $out) {
		...
		// comment by HostCMS ticket 000331240
	...
	protected function lib_mod($args) {
        ...
        return array( "number", intval($this->assertNumber($a)) % $this->assertNumber($b), $args[2][0][2] );
 	}
