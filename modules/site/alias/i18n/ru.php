...
return array(
	...
	<br />Обратите внимание &mdash; на основном домене текущего сайта должна быть доступна система управления <b>и выводиться сообщение о ненайденном лицензионном ключе</b>. Указание основного домена осуществляется в списке доменов.
