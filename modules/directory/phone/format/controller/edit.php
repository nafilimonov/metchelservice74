 ...
 */
class Directory_Phone_Format_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	/**
	...
	protected function _prepareForm()
	{
		...
		$this->title($this->_object->id
			? Core::_('Directory_Phone_Format.edit_title')
			: Core::_('Directory_Phone_Format.add_title')
		);
