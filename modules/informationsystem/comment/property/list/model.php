 ...
 */
class Informationsystem_Comment_Property_List_Model extends Informationsystem_Model
{
	/**
	 * Name of the table
	 * @var string
	 ...
	 * @var string
	 */
	protected $_modelName = 'informationsystem_comment_property_list';
	...
	protected $_hasMany = array(
		'property' => array(
			'through' => 'informationsystem_comment_property',
			'foreign_key' => 'informationsystem_id',
			'dependent_key' => 'property_id'
		),
		'property_dir' => array(
			'through' => 'informationsystem_comment_property_dir',
			'foreign_key' => 'informationsystem_id',
