...
class Core
{
	...
	*/
	...
	{
		return is_string($agent)
			? (bool) preg_match('/360Spider|Applebot|applebot|Baiduspider|baidu|bingbot|BingPreview|Bytespider|coccocbot|Daumoa|DuckDuckBot|duckduckgo|Googlebot|GoogleOther|google|Mail\.RU_Bot|MojeekBot|Rambler|SeznamBot|Sogou|Swisscows|Yahoo|YandexBot|yandex|YisouSpider/iu', $agent)
			: FALSE;
	}
