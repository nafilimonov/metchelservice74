...
/**
 * Shop_Purchase_Discount_Dir_Model
 *
 * @package HostCMS
 * @subpackage Shop
 * @version 7.x
 ...
 */
class Shop_Purchase_Discount_Dir_Model extends Core_Entity
{
	/**
	 * Model name
	 * @var mixed
	 */
	protected $_modelName = 'shop_purchase_discount_dir';
	...
	protected $_hasMany = array(
		...
		'shop_purchase_discount_dir' => array('foreign_key' => 'parent_id')
	);
	...
	protected $_sorting = array(
		'shop_purchase_discount_dirs.sorting' => 'ASC'
	);
	...
	{
		$count = $this->Shop_Purchase_Discounts->getCount();

		$aShop_Purchase_Discount_Dirs = $this->Shop_Purchase_Discount_Dirs->findAll(FALSE);
		foreach ($aShop_Purchase_Discount_Dirs as $oShop_Purchase_Discount_Dir)
		{
			$count += $oShop_Purchase_Discount_Dir->getChildCount();
		}
	 ...
	 * @return self
	 * @hostcms-event shop_purchase_discount_dir.onBeforeRedeclaredDelete
	 */
	 ...
	 * @return Shop_Purchase_Discount_Dir_Model|NULL
	 */
	public function getParent()
	{
		return $this->parent_id
			? Core_Entity::factory('Shop_Purchase_Discount_Dir', $this->parent_id)
			: NULL;
	}
	 ...
	 * @hostcms-event shop_purchase_discount_dir.onBeforeGetRelatedSite
	 * @hostcms-event shop_purchase_discount_dir.onAfterGetRelatedSite
	 */
