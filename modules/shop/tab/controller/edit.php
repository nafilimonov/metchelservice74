		...
		switch ($modelName)
		{
			case 'shop_tab':
				...
				$title = $this->_object->id
					? Core::_('Shop_Tab.edit_title', $this->_object->name, FALSE)
					...
					<script>
						$(function(){
							$("#' . $windowId . ' .shop-tab-groups").select2({
								...
								multiple: true,
								ajax: {
									url: hostcmsBackend + "/shop/item/index.php?shortcuts&includeRoot=1&shop_id=' . $this->_object->shop_id .'",
									dataType: "json",
									type: "GET",
					...
					<script>
						$(function(){
							$("#' . $windowId . ' .shop-tab-items").select2({
								...
								multiple: true,
								ajax: {
									url: hostcmsBackend + "/shop/item/index.php?items&shop_id=' . $this->_object->shop_id .'",
									dataType: "json",
									type: "GET",
									processResults: function (data) {
										var aResults = [];
					...
					<script>
						$(function(){
							$("#' . $windowId . ' .shop-tab-producers").select2({
								...
								multiple: true,
								ajax: {
									url: hostcmsBackend + "/shop/item/index.php?producers&shop_id=' . $this->_object->shop_id .'",
									dataType: "json",
									type: "GET",
									processResults: function (data) {
										var aResults = [];
			...
			case 'shop_tab_dir':
				...
				$title = $this->_object->id
					? Core::_('Shop_Tab_Dir.dir_edit_form_title', $this->_object->name, FALSE)
