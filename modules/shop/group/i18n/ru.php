...
return array(
	...
	'image_large' => "Изображение группы",
	'image_small' => "Малое изображение",
	'sorting' => "Порядок сортировки",
	'indexing' => "Индексировать группу",
	'active' => "Активность",
	...
	'groups_edit_form_title' => 'Редактирование информации о группе товаров "%s"',
	'tab_yandex_market' => 'Экспорт/Импорт',
	'tab_group_description' => 'Описание',
	'tab_group_seo' => 'SEO',
	'parent_id' => 'Группа',
	'exec_typograph_for_description' => 'Типографировать описание',
	...
	'items_catalog_image' => "Изображение группы",
	'items_catalog_image_small' => "Малое изображение группы",
