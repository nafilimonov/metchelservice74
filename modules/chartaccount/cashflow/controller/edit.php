...
/**
 * Chartaccount_Cashflow_Controller_Edit
 *
 * @package HostCMS
 ...
 */
class Chartaccount_Cashflow_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	/**
	...
	protected function _prepareForm()
	{
		...
		$this->title($this->_object->id
			? Core::_('Chartaccount_Cashflow.edit_title', $this->_object->name, FALSE)
			: Core::_('Chartaccount_Cashflow.add_title')
		);
