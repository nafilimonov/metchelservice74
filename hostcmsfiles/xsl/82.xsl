			...
			<body>
				<div class="main_div">
					...
					<tr>
						...
						<td class="td_header">Цена,<xsl:text> </xsl:text><xsl:value-of disable-output-escaping="yes" select="/shop/shop_order/shop_currency/sign" /></td>
						<td class="td_header">Ставка НДС</td>
						<td class="td_header">НДС,<xsl:text> </xsl:text><xsl:value-of disable-output-escaping="yes" select="/shop/shop_order/shop_currency/sign" /></td>
						<td class="td_header" style="border-right: black 1px solid; border-left: black 1px solid;">Сумма, <xsl:text> </xsl:text><xsl:value-of disable-output-escaping="yes" select="/shop/shop_order/shop_currency/sign" /></td>
					</tr>
					<!-- Элементы заказа -->
